...
(function () {
    ...
    var game = {
        ...
        addListeners: function () {
            ...
            this.grid.addEventListener('contextmenu', _.bind(this.clickVerticalPosition, this));
        },

        clickVerticalPosition: function (e) {

            if (this.getPhase() === this.PHASE_INIT_PLAYER) {
                e.preventDefault();
                var ship = this.players[0].fleet[this.players[0].activeShip];
                if (this.ordered === "horizontal") {
                    this.ordered = "vertical";
                    ship.dom.style.transform = "rotate(90deg)";
                } else {
                    this.ordered = "horizontal";
        ...
        handleMouseMove: function (e) {
            ...
            if (this.getPhase() === this.PHASE_INIT_PLAYER && e.target.classList.contains('cell')) {
                ...
                if (((ship.life) % 2) === 0 && this.ordered === "vertical") {
